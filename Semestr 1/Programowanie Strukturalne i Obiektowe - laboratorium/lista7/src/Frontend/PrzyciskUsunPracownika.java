...
public class PrzyciskUsunPracownika{
    public JFrame frame;
    public PrzyciskUsunPracownika() {
        SwingUtilities.invokeLater(new Runnable() {
            @Override
            public void run() {
                frame = new JFrame("Usuwanie pracowników");
    ...
    public class Panel1 extends JPanel{
        public Panel1(){
            ...
            JCheckBox checkBox3 = new JCheckBox("Staż pracy");wyborFiltru.add(checkBox3);
            JCheckBox checkBox4 = new JCheckBox("Stanowisko");wyborFiltru.add(checkBox4);
            ...
            button0.addActionListener(new ActionListener(){
                public void actionPerformed(ActionEvent e){
                    ...
                    Main.setOsoby(Funkcje.usunPracownikow(Main.getOsoby(), filtr, fraza));
                    new PrzyciskKontynuuj("Usunięto pracowników.");
                    frame.dispose();
                }
            });
