...
public class PrzyciskWyswietlKursy {
    public JFrame frame;
    public PrzyciskWyswietlKursy() {
        SwingUtilities.invokeLater(new Runnable() {
            @Override
            public void run() {
                frame = new JFrame("Wszystkie kursy");
    ...
    public class Panel1 extends JPanel{
        public Panel1(){
            ...
            JLabel naglowek = new JLabel("Wszystkie kursy:");
            ...
            for (int i = 0; i< Main.getKursy().size(); i++) {
                    elementy.add(new JLabel((i + 1) + ". " + Main.getKursy().get(i).toString()), gbc);
            }
