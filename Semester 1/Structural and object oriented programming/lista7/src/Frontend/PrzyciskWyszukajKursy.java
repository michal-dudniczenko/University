...
public class PrzyciskWyszukajKursy{
    public JFrame frame;
    public PrzyciskWyszukajKursy() {
        SwingUtilities.invokeLater(new Runnable() {
            @Override
            public void run() {
                frame = new JFrame("Wyszukiwanie kursów");
    ...
    public class Panel1 extends JPanel{
        public Panel1(){
            ...
            JCheckBox checkBox1 = new JCheckBox("Nazwa kursu");wyborFiltru.add(checkBox1);
            JCheckBox checkBox2 = new JCheckBox("Nazwisko prowadzącego");wyborFiltru.add(checkBox2);
            JCheckBox checkBox3 = new JCheckBox("Liczba punktów ECTS");wyborFiltru.add(checkBox3);
            ...
            button0.addActionListener(new ActionListener(){
                public void actionPerformed(ActionEvent e){
                    ...
                    new WynikiWyszukiwaniaKursow(Funkcje.wyszukajKurs(Main.getKursy(), filtr, fraza));
                    frame.dispose();
                }
            });
