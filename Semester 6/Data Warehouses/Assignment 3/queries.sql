...
SELECT DISTINCT 
   ...
   COUNT(oh.SalesOrderID) OVER (PARTITION BY oh.SalesPersonID, YEAR(oh.OrderDate)) AS [Liczba zam�wie�]
FROM sales.SalesOrderHeader oh
...
SELECT 
   ...
   COUNT(oh.SalesOrderID) AS [Liczba zam�wie�],
