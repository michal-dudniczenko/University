...
fun BottomNavbar(
    ...
    Row(
        ...
        for (i in TOP_LEVEL_SCREENS.indices) {
            BottomNavbarIcon(
                screenNumber = i,
...
fun BottomNavbarIcon(
    ...
    var currentScreen by currentTopLevelScreen
    ...
    Column(
        ...
        modifier = modifier
            ...
            .clickable {
                ...
                navController.navigate(TOP_LEVEL_SCREENS[screenNumber])
            }
    ) {
        Box(
            modifier = Modifier
            ...
            Image(
                ...
                contentDescription = "${TOP_LEVEL_SCREENS[screenNumber]} screen icon"
            )
        }
    }
}