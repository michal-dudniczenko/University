...
internal static class GetOtherProfileEndpoint
{
    public static IEndpointRouteBuilder MapGetOtherUserProfile(this IEndpointRouteBuilder app)
    {
        app.MapGet("/users/{userId}", HandleAsync)
            ...
            .Produces<GetOtherUserProfileResponse>(StatusCodes.Status200OK)
        ...
        CancellationToken cancellationToken)
    {
        ...
        if ((bool)otherUser.IsBand)
        {
            ...
            return TypedResults.Ok<GetOtherUserProfileResponse>(new OtherUserProfileBandResponse
            {
                Id = band.User.Id,
        ...
        else
        {
            ...
            return TypedResults.Ok<GetOtherUserProfileResponse>(new OtherUserProfileArtistResponse
            {
                Id = artist.User.Id,
