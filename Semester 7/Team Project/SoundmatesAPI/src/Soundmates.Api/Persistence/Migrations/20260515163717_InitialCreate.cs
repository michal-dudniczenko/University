        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    IsForBand = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ShowArtists = table.Column<bool>(type: "bit", nullable: false),
                    ShowBands = table.Column<bool>(type: "bit", nullable: false),
                    MaxDistance = table.Column<int>(type: "int", nullable: true),
                    CountryId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    CityId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    ArtistMinAge = table.Column<int>(type: "int", nullable: true),
                    ArtistMaxAge = table.Column<int>(type: "int", nullable: true),
                    ArtistGenderId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    BandMinMembersCount = table.Column<int>(type: "int", nullable: true),
                    BandMaxMembersCount = table.Column<int>(type: "int", nullable: true),
                    UserId = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    TagsId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    UserMatchPreferenceId = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TagUserMatchPreference_UserMatchPreferences_UserMatchPreferenceId",
