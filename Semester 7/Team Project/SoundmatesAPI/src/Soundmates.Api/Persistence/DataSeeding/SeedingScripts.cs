...
namespace Soundmates.Api.Persistence.DataSeeding;

internal static class SeedingScripts
{
    private const string SeedDataDirectoryPath = "Persistence/DataSeeding/SeedData";
    ...
    private sealed record CountryCitySeedEntity(string City, string Country, double Lat, double Lng);
    private sealed record GenderSeedEntity(string Name);
    private sealed record BandRoleSeedEntity(string Name);
    private sealed record TagCategorySeedEntity(string Name);
    private sealed record TagSeedEntity(string Name, string CategoryName);
}
